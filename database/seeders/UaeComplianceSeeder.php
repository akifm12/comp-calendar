...
class UaeComplianceSeeder extends Seeder
{
    ...
    private function seedActivities(): void
    {
        ...
        $activities = [
            ...
            // ── Ministry of Economy – Real Estate DNFBPs ──────────────────────────
            ['name' => 'Real Estate Broker (AML/CFT – MoE)',       'sector' => 'real_estate',         'reg' => 'MoE', 'description' => 'Real estate brokerage subject to Ministry of Economy AML/CFT obligations as a DNFBP under Federal Decree-Law No. 20/2018.'],
            ['name' => 'Real Estate Developer (AML/CFT – MoE)',    'sector' => 'real_estate',         'reg' => 'MoE', 'description' => 'Real estate developer subject to Ministry of Economy AML/CFT obligations as a DNFBP under Federal Decree-Law No. 20/2018.'],
            ['name' => 'Property Manager (AML/CFT – MoE)',         'sector' => 'real_estate',         'reg' => 'MoE', 'description' => 'Property management company subject to Ministry of Economy AML/CFT obligations as a DNFBP under Federal Decree-Law No. 20/2018.'],
    ...
    private function requirementsData(): array
    {
        return [
            ...
            // ── MoE – Real Estate DNFBP ───────────────────────────────────────────
            ['regulator'=>'MoE','activity'=>'Real Estate Broker (AML/CFT – MoE)','title'=>'Annual Real Estate DNFBP AML/CFT Registration Renewal','frequency'=>'annual','category'=>'Licensing','channel'=>'Ministry of Economy DNFBP Portal','penalty'=>'Failure to register or renew as a DNFBP with the Ministry of Economy is an offence under Cabinet Decision No. 10/2019 with fines up to AED 1 million.','description'=>'Real estate brokers must register and annually renew their DNFBP status with the Ministry of Economy, confirming AML/CFT compliance programme details, MLRO appointment, and goAML registration.'],
            ['regulator'=>'MoE','activity'=>'Real Estate Broker (AML/CFT – MoE)','title'=>'Quarterly Real Estate Transaction AML Monitoring Report','frequency'=>'quarterly','category'=>'AML/CFT','channel'=>'Internal records; available for MoE inspection','description'=>'Prepare and retain a quarterly internal report reviewing all high-value real estate transactions for AML/CFT red flags, including cash transactions, PEP involvement, unusual ownership structures, and suspicious activity.'],
            ['regulator'=>'MoE','activity'=>'Real Estate Developer (AML/CFT – MoE)','title'=>'Annual Real Estate Developer DNFBP AML/CFT Registration Renewal','frequency'=>'annual','category'=>'Licensing','channel'=>'Ministry of Economy DNFBP Portal','penalty'=>'Failure to register as a DNFBP may result in fines and suspension of development activities under Federal Decree-Law No. 20/2018.','description'=>'Real estate developers must register and annually renew their DNFBP status with the Ministry of Economy. Submit evidence of AML programme, MLRO appointment, risk assessment, and goAML activity.'],
            ['regulator'=>'MoE','activity'=>'Real Estate Developer (AML/CFT – MoE)','title'=>'Escrow & Buyer Due Diligence Annual Review','frequency'=>'annual','category'=>'AML/CFT','channel'=>'Internal records; available for MoE inspection','description'=>'Conduct and document an annual review of buyer due diligence (KYC) procedures for off-plan and completed unit sales, confirming source of funds verification, PEP screening, and beneficial ownership checks.'],
            ['regulator'=>'MoE','activity'=>'Property Manager (AML/CFT – MoE)','title'=>'Annual Property Manager DNFBP AML/CFT Registration Renewal','frequency'=>'annual','category'=>'Licensing','channel'=>'Ministry of Economy DNFBP Portal','description'=>'Property management companies handling client funds or lease transactions must register and renew their DNFBP status with the Ministry of Economy and maintain a compliant AML/CFT programme.'],
